  ...
  return (
    <div className='flex flex-wrap gap-4 justify-center items-center'>
      <div className={`w-[350px] h-[260px] my-[30px] flex flex-col gap-4 p-4 bg-secondary rounded-lg shadow-md relative`}>
        ...
        <Link className='font-bold inline-block w-fit border-2 border-white hover:bg-primaryHover p-2 rounded-md' href={'/sell-a-car'}>
          Sell Now...</Link>
      </div>
      <div className={`w-[350px] h-[260px] my-[30px] flex flex-col gap-4 p-4 bg-primary rounded-lg shadow-md relative`}>
        ...
        <Link className='font-bold inline-block w-fit border-2 border-white hover:bg-primaryHover p-2 rounded-md' href={'/rent-a-car'}>
          Rent Now...</Link>
      </div>
    </div>
  )
